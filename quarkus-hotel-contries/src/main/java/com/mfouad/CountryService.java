...
public class CountryService {
	...
	public void activateDeactive(ActiveDeCountryReq req) {

		Country c = entityManager.find(Country.class, req.getCountryID());

		if (c == null)
			throw new CountryNotFoundException("Country with id " + req.getCountryID() + " not found");
